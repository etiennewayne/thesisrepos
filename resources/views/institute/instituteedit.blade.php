            ...
            <div class="card">
                ...
                <form method="POST" action="/panel/institutes/{{ $institute->instituteID }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="instituteCode" type="text" class="form-control @error('instituteCode') is-invalid @enderror" name="instituteCode" value="{{ $institute->instituteCode }}" required autocomplete="off" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="instituteDesc" type="text" class="form-control @error('instituteDesc') is-invalid @enderror" name="instituteDesc" value="{{ $institute->instituteDesc }}" required autocomplete="off" autofocus>
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="instituteCode" id="instituteCode" required>
                                   @foreach ($institutes as $ins)
                                        @if( $ins->instituteCode == $program->programCode )
