    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                <form method="POST" action="/panel/academicyear">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" id="acode" class="form-control @error('acode') is-invalid @enderror" name="acode" rows="3" value="{{ old('acode') }}" 
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" id="acode_desc" class="form-control @error('acode_desc') is-invalid @enderror" name="acode_desc" rows="3" value="{{ old('acode_desc') }}" 
                                required autocomplete="off" autofocus />
