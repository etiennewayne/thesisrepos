                ...
                <div class="card-body">
                    <form method="POST" action="/theses" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="thesistitle" type="text" class="form-control @error('thesistitle') is-invalid @enderror" name="thesistitle" value="{{ old('thesistitle') }}" required autocomplete="off" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input id="thesisdesc" type="text" class="form-control @error('thesisdesc') is-invalid @enderror" name="thesisdesc" value="{{ old('thesisdesc') }}" required autocomplete="off" autofocus>
